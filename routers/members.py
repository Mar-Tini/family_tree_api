...
async def add_member(new_member: Member):
...
async def update_member(member_id: str, updated_member: MemberModify):
...
async def upload_image(member_id: str, file: UploadFile = File(...)):
